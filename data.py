class TestData:
    test_data_user1 = ['Алёна', 'Кит', 'Плеханова улица, 17', 'Перово', '89999998989', '06.07.2025',
                       'сутки']

    test_data_user2 = ['Пётр', 'Скука', 'Профсоюзная улица, 125А', 'Теплый Стан', '88005553535', '07.07.2025',
                       'семеро суток']
